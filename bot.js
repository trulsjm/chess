...
function bot_move() {
    ...
    const legal_moves = get_all_legal_moves(bot_pov)
...
function minimax(maximizing_bot, depth, alpha, beta) { // Depth is the number of moves ahead the bot will look counting white and black individually
    ...
    // minimizing bot
        ...
        let minEval = 10000;
        let moveIndex = null;
        const legal_moves = get_all_legal_moves((bot_pov + 1) % 2);
...
function set_piece_values () {
    ...
    piece_values = {
        1: 100000 * piece_value_prefix,
        2: 100 * piece_value_prefix,
        3: 300 * piece_value_prefix,
        4: 300 * piece_value_prefix,
        5: 500 * piece_value_prefix,
        6: 900 * piece_value_prefix,
        9: -100000 * piece_value_prefix,
...
function get_all_legal_moves(color) {
    ...
    for (let i = 6; i >= 1; i--) {
        ...
        for (let j = 0; j < piece_indexes.length; j++) {
            const piece_moves = get_legal_moves(piece_indexes[j]);
